...
module wb_stage(
    ...
    wire [`WORD_BUS]    data = (cpu_rst_n == `RST_ENABLE) ? `ZERO_WORD :
                                ...
                                (wb_dre_i == 4'b1000) ? (wb_msext_i == `TRUE_V ? {24'b0, dm[31:24]} : {{24{dm[31]}}, dm[31:24]}) : 
                                (wb_dre_i == 4'b0100) ? (wb_msext_i == `TRUE_V ? {24'b0, dm[23:16]} : {{24{dm[23]}}, dm[23:16]}) :
                                (wb_dre_i == 4'b0010) ? (wb_msext_i == `TRUE_V ? {24'b0, dm[15:8]} : {{24{dm[15]}}, dm[15:8]}) :
                                (wb_dre_i == 4'b0001) ? (wb_msext_i == `TRUE_V ? {24'b0, dm[7:0]} : {{24{dm[7]}}, dm[7:0]}) : 
                                (wb_dre_i == 4'b1100) ? (wb_msext_i == `TRUE_V ? {16'b0, dm[23:16], dm[31:24]} : {{16{dm[23]}}, dm[23:16], dm[31:24]}) :
                                (wb_dre_i == 4'b0011) ? (wb_msext_i == `TRUE_V ? {16'b0, dm[7:0], dm[15:8]} : {{16{dm[7]}}, dm[7:0], dm[15:8]}) : `ZERO_WORD;
