...
module exe_stage (
    ...
    //判读是否存在cp0寄存器的数据相关，并获得cp0寄存器中的最新值                  
    ...
    assign exe_hilo_o = (cpu_rst_n == `RST_ENABLE) ? `ZERO_DWORD : 
                        ...
                        (exe_aluop_i == `MINIMIPS32_MTHI) ? {exe_src1_i[31 : 0], exe_hilo_o[31 : 0]} :
                        (exe_aluop_i == `MINIMIPS32_MTLO) ? {exe_hilo_o[63 : 32], exe_src1_i[31 : 0]} : `ZERO_WORD;
